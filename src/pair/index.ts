...
import { compactAddLength, objectSpread, u8aConcat, u8aEmpty, u8aEq, u8aToHex, u8aToU8a } from '@noir/util';
...
const TYPE_ADDRESS = {
  ecdsa: (p: Uint8Array) => u8aConcat(new Uint8Array([0xe7, 0x01]), p),
  ed25519: (p: Uint8Array) => u8aConcat(new Uint8Array([0xed, 0x01]), p),
  ethereum: (p: Uint8Array) => p.length === 20 ? p : keccakAsU8a(secp256k1Expand(p)),
  sr25519: (p: Uint8Array) => u8aConcat(new Uint8Array([0xef, 0x01]), p)
};
